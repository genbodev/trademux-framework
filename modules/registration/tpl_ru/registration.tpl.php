...
<tr>
	...
	<td width="125" style="padding-left: 45px">Повтор пароля:</td>
	<td>
...
<tr>
	...
	<td style="padding-left: 45px">Фамилия:</td>
...
<tr>
	<td colspan="4" align="center"><input type="submit" class="button btn btn-primary" style="margin-top: 25px;" value="Открыть счет"></td>
</tr>
</table>
</form>

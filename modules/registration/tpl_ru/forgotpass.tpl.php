						...
						<article>
							...
							<section class="article-content clearfix trader">
								...
								<form method="post" action="<?=$this->url('registration', 'forgotsend')?>" id="saveform">
									<div style="float: left; margin: 5px 10px;">Введите Email адрес: </div>
									<input type="text" name="email" class="rcemail" /> 
									<input type="submit" value="Отослать" class="button btn btn-primary" style="margin: -12px 10px 0 10px;"/>
